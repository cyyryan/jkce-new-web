...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      { name: '住宅建设', path: '/services#residential' },
      { name: '商业建筑', path: '/services#commercial' },
      { name: '基础设施', path: '/services#infrastructure' },
      { name: '装修工程', path: '/services#renovation' }
    ],
    company: [
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-xl font-bold">JKCE承建商</span>
              </div>
              <p className="text-secondary-300 mb-6 max-w-md">
                JKCE承建商是专业的建筑工程服务提供商，致力于为客户提供高品质的建筑解决方案。
                15年专业经验，500+成功项目，是您值得信赖的建筑合作伙伴。
              </p>
        ...
        <div className="border-t border-secondary-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <Link to="/sitemap" className="text-secondary-400 hover:text-white transition-colors duration-200">
                网站地图
              </Link>
            </div>
          </div>
