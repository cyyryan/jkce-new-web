      ...
      <div className="container-custom">
          ...
          <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-8 md:p-12 relative">
            ...
            <div className="absolute inset-y-0 left-4 flex items-center">
              <button
                ...
                className="w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center text-secondary-600 hover:text-primary-600 transition-colors duration-200"
              >
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          ...
          <div className="text-center">
            ...
            <div className="text-secondary-600">成功项目</div>
          </div>
          <div className="text-center">
