        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2">24小时热线</h3>
              <p className="text-primary-200 text-sm">400-888-8888</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-primary-200 text-sm">专业客服为您解答</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-primary-200 text-sm">免费现场勘测</p>
            </div>
          </div>
        </div>
      </div>
